...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        push=(ListView)findViewById(R.id.push_list);

        adapter = new CustomAdapter3();

        pintent=getIntent();
        user_email=pintent.getExtras().getString("email");
        GetPush task = new GetPush();
        task.execute(user_email);
    }

    public class GetPush extends AsyncTask<String, Void, String> {
        @Override
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (jsonArray.length()!=0) {
                        ...
                        push.setAdapter(adapter);
                        setListViewHeightBasedOnChildren(push);
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://54.180.159.44/push.php";
